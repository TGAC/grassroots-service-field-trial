...
static ServiceJobSet *RunPhenotypesSubmissionService (Service *service_p, ParameterSet *param_set_p, UserDetails *user_p, ProvidersStateTable *providers_p);


static bool ClosePhenotypesSubmissionService (Service *service_p);

static ServiceMetadata *GetPhenotypesSubmissionServiceMetadata (Service *service_p);
...
Service *GetPhenotypesSubmissionService (GrassrootsServer *grassroots_p)
{
			...
			if (data_p)
				{
					if (InitialiseService (service_p,
														 ...
														 NULL,
														 GetPhenotypesSubmissionServiceParameters,
														 GetPhenotypesSubmissionServiceParameterTypesForNamedParameters,
														 ReleasePhenotypesSubmissionServiceParameters,
														 ClosePhenotypesSubmissionService,
														 NULL,
														 false,
														 SY_SYNCHRONOUS,
														 (ServiceData *) data_p,
														 GetPhenotypesSubmissionServiceMetadata,
														 NULL,
														 grassroots_p))
						{
...
static ParameterSet *GetPhenotypesSubmissionServiceParameters (Service *service_p, Resource * UNUSED_PARAM (resource_p), UserDetails * UNUSED_PARAM (user_p))
{
	...
	if (params_p)
		...
		{
			PrintErrors (STM_LEVEL_SEVERE, __FILE__, __LINE__, "Failed to allocate %s ParameterSet", GetPhenotypesSubmissionServiceName (service_p));
		}
...
static void ReleasePhenotypesSubmissionServiceParameters (Service * UNUSED_PARAM (service_p), ParameterSet *params_p)
{
	FreeParameterSet (params_p);
}
...
static ServiceJobSet *RunPhenotypesSubmissionService (Service *service_p, ParameterSet *param_set_p, UserDetails * UNUSED_PARAM (user_p), ProvidersStateTable * UNUSED_PARAM (providers_p))
{
	DFWFieldTrialServiceData *data_p = (DFWFieldTrialServiceData *) (service_p -> se_data_p);

	service_p -> se_jobs_p = AllocateSimpleServiceJobSet (service_p, NULL, "Submit Phenotypes");
