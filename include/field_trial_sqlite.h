...
#ifndef SERVICES_FIELD_TRIALS_INCLUDE_FIELD_TRIAL_SQLITE_H_
#define SERVICES_FIELD_TRIALS_INCLUDE_FIELD_TRIAL_SQLITE_H_
...
#endif /* SERVICES_FIELD_TRIALS_INCLUDE_FIELD_TRIAL_SQLITE_H_ */
