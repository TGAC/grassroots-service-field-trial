...
DFW_FIELD_TRIAL_SERVICE_LOCAL bool AddRowToPlot (Plot *plot_p, struct BaseRow *row_p);


DFW_FIELD_TRIAL_SERVICE_LOCAL struct BaseRow *GetRowFromPlotByStudyIndex (Plot *plot_p, const uint32 by_study_index);
...
DFW_FIELD_TRIAL_SERVICE_LOCAL struct BaseRow *GetRowFromPlotByRackIndex (Plot *plot_p, const uint32 rack_index);
