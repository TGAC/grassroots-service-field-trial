...
STUDY_JOB_PREFIX NamedParameterType STUDY_PLOT_ROWS_PER_BLOCK STUDY_JOB_STRUCT_VAL("ST Num Rows", PT_UNSIGNED_INT);
STUDY_JOB_PREFIX NamedParameterType STUDY_PLOT_COLS_PER_BLOCK STUDY_JOB_STRUCT_VAL("ST Num Columns", PT_UNSIGNED_INT);
