...
DFW_FIELD_TRIAL_SERVICE_LOCAL const COScaleClass SCALE_DURATION DFW_FIELD_TRIAL_SERVICE_STRUCT_VAL ("Duration", PT_TIME);
DFW_FIELD_TRIAL_SERVICE_LOCAL const COScaleClass SCALE_NOMINAL DFW_FIELD_TRIAL_SERVICE_STRUCT_VAL ("Nominal", PT_STRING);
DFW_FIELD_TRIAL_SERVICE_LOCAL const COScaleClass SCALE_NUMERICAL DFW_FIELD_TRIAL_SERVICE_STRUCT_VAL ("Numerical", PT_SIGNED_REAL);
DFW_FIELD_TRIAL_SERVICE_LOCAL const COScaleClass SCALE_CODE DFW_FIELD_TRIAL_SERVICE_STRUCT_VAL ("Code", PT_STRING);
DFW_FIELD_TRIAL_SERVICE_LOCAL const COScaleClass SCALE_ORDINAL DFW_FIELD_TRIAL_SERVICE_STRUCT_VAL ("Ordinal", PT_STRING);
DFW_FIELD_TRIAL_SERVICE_LOCAL const COScaleClass SCALE_TEXT DFW_FIELD_TRIAL_SERVICE_STRUCT_VAL ("Text", PT_STRING);
DFW_FIELD_TRIAL_SERVICE_LOCAL const COScaleClass SCALE_DATE DFW_FIELD_TRIAL_SERVICE_STRUCT_VAL ("Date", PT_TIME);
...
DFW_FIELD_TRIAL_SERVICE_LOCAL const COScaleClass *GetScaleClassByName (const char * const name_s);
