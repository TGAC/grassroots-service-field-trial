...
DFW_FIELD_TRIAL_SERVICE_LOCAL NumericObservation *AllocateNumericObservation (bson_oid_t *id_p, const ObservationMetadata *metadata_p,
																																							MeasuredVariable *phenotype_p, MEM_FLAG phenotype_mem,
																																							const double *raw_value_p, const double *corrected_value_p,
...
DFW_FIELD_TRIAL_SERVICE_LOCAL bool AddNumericObservationValuesToJSON (const Observation *obs_p, const char *raw_key_s, const char *corrected_key_s, json_t *json_p, const char *null_sequence_s, bool only_if_exists_flag);
