...
DFW_FIELD_TRIAL_SERVICE_LOCAL bool GetTimeObservationRawValueAsString (const TimeObservation *observation_p, char **value_ss, bool *free_flag_p);


DFW_FIELD_TRIAL_SERVICE_LOCAL bool GetTimeObservationCorrectedValueAsString (const TimeObservation *observation_p, char **value_ss, bool *free_flag_p);
