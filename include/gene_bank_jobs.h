...
#ifndef SERVICES_FIELD_TRIALS_INCLUDE_GENE_BANK_JOBS_H_
#define SERVICES_FIELD_TRIALS_INCLUDE_GENE_BANK_JOBS_H_
...
#endif /* SERVICES_FIELD_TRIALS_INCLUDE_GENE_BANK_JOBS_H_ */
