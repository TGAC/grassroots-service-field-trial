...
TREATMENT_PREFIX const char *MV_TRAIT_S TREATMENT_VAL ("trait");

TREATMENT_PREFIX const char *MV_MEASUREMENT_S TREATMENT_VAL ("measurement");

TREATMENT_PREFIX const char *MV_UNIT_S TREATMENT_VAL ("unit");

TREATMENT_PREFIX const char *MV_VARIABLE_S TREATMENT_VAL ("variable");

TREATMENT_PREFIX const char *MV_FORM_S TREATMENT_VAL ("form");

TREATMENT_PREFIX const char *MV_VALUE_S TREATMENT_VAL ("value");

TREATMENT_PREFIX const char *MV_INTERNAL_NAME_S TREATMENT_VAL ("internal_name");
