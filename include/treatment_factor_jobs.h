...
TREATMENT_FACTOR_JOB_PREFIX NamedParameterType TFJ_STUDY_ID TREATMENT_FACTOR_JOB_STRUCT_VAL ("Study ID", PT_STRING);
TREATMENT_FACTOR_JOB_PREFIX NamedParameterType TFJ_TREATMENT_ID TREATMENT_FACTOR_JOB_STRUCT_VAL ("Treatment ID", PT_STRING);
TREATMENT_FACTOR_JOB_PREFIX NamedParameterType TFJ_TREATMENT_NAME TREATMENT_FACTOR_JOB_STRUCT_VAL ("Treatment Name", PT_STRING);
TREATMENT_FACTOR_JOB_PREFIX NamedParameterType TFJ_VALUES TREATMENT_FACTOR_JOB_STRUCT_VAL ("Levels", PT_JSON_TABLE);
