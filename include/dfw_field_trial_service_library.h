...
*/
  ...
  #define DFW_FIELD_TRIAL_SERVICE_LOCAL
	...
	#define DFW_FIELD_TRIAL_SERVICE_PREFIX DFW_FIELD_TRIAL_SERVICE_LOCAL
	#define DFW_FIELD_TRIAL_SERVICE_VAL(x)	= x
	#define DFW_FIELD_TRIAL_SERVICE_STRUCT_VAL(x,y)	= { x, y}
#else
	#define DFW_FIELD_TRIAL_SERVICE_PREFIX extern
	#define DFW_FIELD_TRIAL_SERVICE_VAL(x)
	#define DFW_FIELD_TRIAL_SERVICE_STRUCT_VAL(x,y)
#endif
