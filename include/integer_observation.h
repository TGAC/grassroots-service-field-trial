...
DFW_FIELD_TRIAL_SERVICE_LOCAL bool AddIntegerObservationValuesToJSON (const IntegerObservation *obs_p, const char *raw_key_s, const char *corrected_key_s, json_t *json_p, const char *null_sequence_s, bool only_if_exists_flag);
