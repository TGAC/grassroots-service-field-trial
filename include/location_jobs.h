...
LOCATION_JOB_PREFIX NamedParameterType STUDY_MIN_PH LOCATION_JOB_STRUCT_VAL("pH Minimum", PT_UNSIGNED_REAL);
LOCATION_JOB_PREFIX NamedParameterType STUDY_MAX_PH LOCATION_JOB_STRUCT_VAL("pH Maximum", PT_UNSIGNED_REAL);
