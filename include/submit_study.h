...
#ifndef SERVICES_FIELD_TRIALS_INCLUDE_SUBMIT_STUDY_H_
#define SERVICES_FIELD_TRIALS_INCLUDE_SUBMIT_STUDY_H_
...
#endif /* SERVICES_FIELD_TRIALS_INCLUDE_SUBMIT_STUDY_H_ */
